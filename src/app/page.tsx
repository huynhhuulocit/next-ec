    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">Discover amazing products at unbeatable prices. Shop with confidence and enjoy a seamless shopping experience.</p>
            <Link 
              href="/products" 
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Join thousands of satisfied customers who shop with us.</p>
          <Link 
            href="/products" 
